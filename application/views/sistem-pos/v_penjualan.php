  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
            <form action="<?php echo base_url().'sistem-pos/penjualan/add_to_cart'?>" method="post">
            <table>
                <tr>
                    <th>Kode Barang</th>
                </tr>
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;margin-top:10px;">
                ...
                <tbody>
                    ...
                    <tr>
                         ...
                         <td style="text-align:center;"><a href="<?php echo base_url().'sistem-pos/penjualan/remove/'.$items['rowid'];?>" class="btn btn-warning btn-xs"><span class="fa fa-close"></span> Batal</a></td>
                    </tr>
            ...
            <form action="<?php echo base_url().'sistem-pos/penjualan/simpan_penjualan'?>" method="post">
            <table>
                <tr>
        ...
        $(document).ready(function(){
            ...
            $("#kode_brg").on("input",function(){
                var kobar = {kode_brg:$(this).val()};
                   $.ajax({
               type: "POST",
               url : "<?php echo base_url().'sistem-pos/penjualan/get_barang';?>",
               data: kobar,
