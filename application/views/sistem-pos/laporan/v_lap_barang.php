...
$nomor=1;
    ...
    $group=$d['nama_kategori'];
        ...
        <tr>
                ...
                <td style="vertical-align:center;padding-left:5px;text-align:center;"><?php echo $d['id_barang']; ?></td>
                <td style="vertical-align:center;padding-left:5px;"><?php echo $d['nama_barang']; ?></td>
                <td style="vertical-align:center;text-align:center;"><?php echo $d['satuan_barang']; ?></td>
                <td style="vertical-align:center;padding-right:5px;text-align:right;"><?php echo 'Rp '.number_format($d['harga_jual_barang']); ?></td>
                <td style="vertical-align:center;text-align:center;text-align:center;"><?php echo $d['stok_barang']; ?></td>  
        </tr>
