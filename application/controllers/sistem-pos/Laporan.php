...
class Laporan extends CI_Controller{
	...
	if($this->session->userdata('akses')=='1'){
		...
		$this->load->view('sistem-pos/v_laporan',$data);
	}else{
	...
	public function lap_penjualan_pertanggal(){
		...
		$this->load->view('sistem-pos/laporan/v_lap_jual_pertanggal',$x);
	}
	public function lap_penjualan_perbulan(){
		...
		$this->load->view('sistem-pos/laporan/v_lap_jual_perbulan',$x);
	}
	public function lap_penjualan_pertahun(){
		...
		$this->load->view('sistem-pos/laporan/v_lap_jual_pertahun',$x);
	}
	public function lap_laba_rugi(){
		...
		$this->load->view('sistem-pos/laporan/v_lap_laba_rugi',$x);
	}
}