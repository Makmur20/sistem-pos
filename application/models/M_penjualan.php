...
class M_penjualan extends CI_Model{
	...
	public function simpan_penjualan($nofak,$total,$jml_uang,$kembalian){
		...
		$this->db->query("INSERT INTO tbl_jual (jual_nofak,jual_total,jual_jml_uang,jual_kembalian,jual_user_id,jual_keterangan) VALUES ('$nofak','$total','$jml_uang','$kembalian','$idadmin','Lunas')");
		foreach ($this->cart->contents() as $item) {
			...
			$this->db->query("update tbl_barang set stok_barang=stok_barang-'$item[qty]' where id_barang='$item[id]'");
		}
		return true;
	}
